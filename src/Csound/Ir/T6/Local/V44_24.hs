-- | Searches for IR-files in the directory samples located
-- at the same directory as the csd file.
--
-- "samples/Samplicity T600 - 05 - Wave, 24 bit, 44.1 khz/preset-name"
module Csound.Ir.T6.Local.V44_24(
    -- * Halls
...
rootDir = "samples" </> "Samplicity T600 - 05 - Wave, 24 bit, 44.1 khz"
