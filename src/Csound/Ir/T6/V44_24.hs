...
-- "HOME_USER/.csound-ir/samplicity_t600_v1.3/Samplicity T600 - 02 - Wave, 32 bit, 48 khz"
module Csound.Ir.T6.V44_24(
    -- * Halls
...
rootDir = ".csound-ir" </> "samplicity_t600_v1.3" </> "Samplicity T600 - 05 - Wave, 24 bit, 44.1 khz"
